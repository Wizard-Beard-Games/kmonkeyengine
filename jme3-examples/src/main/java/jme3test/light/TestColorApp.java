...
public class TestColorApp extends SimpleApplication {
    ...
    public void simpleInitApp() {
        ...
        //DirectionalLightShadowFilter sun_renderer = new DirectionalLightShadowFilter(_assetManager, 2048, 4);
        DirectionalLightShadowRenderer sun_renderer = new DirectionalLightShadowRenderer(_assetManager, 2048, 1);
...
//        viewPort.addProcessor(fpp);
        ...
        final Material groundMaterial = new Material(_assetManager, "Common/MatDefs/Light/Lighting.j3md");
        ...
        final Material planterMaterial = new Material(_assetManager, "Common/MatDefs/Light/Lighting.j3md");
        planterMaterial.setTexture("DiffuseMap", _assetManager.loadTexture("Textures/Terrain/BrickWall/BrickWall.jpg"));
