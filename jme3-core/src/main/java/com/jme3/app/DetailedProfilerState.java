...
//        Material mat = new Material(app.get_assetManager(), "Common/MatDefs/Misc/Unshaded.j3md");
...
//        font = app.get_assetManager().loadFont("Interface/Fonts/Console.fnt");
//        bigFont = app.get_assetManager().loadFont("Interface/Fonts/Default.fnt");
